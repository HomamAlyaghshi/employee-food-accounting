...
const translations = {
  en: {
    ...
    employees: {
      ...
      startByAddingEmployees:
        'Start by adding your employees. You can add as many as you need, then proceed to create orders.',
      gotIt: 'Got it!',
  ...
  ar: {
    ...
    employees: {
      ...
      startByAddingEmployees:
        'ابدأ بإضافة الموظفين. يمكنك إضافة العدد الذي تريده، ثم المتابعة لإنشاء الطلبات.',
      gotIt: 'فهمت!',
...
export const LanguageProvider = ({ children }) => {
  ...
  const t = (key) => {
    ...
    if (typeof value === 'object' && value !== null) {
      console.error(
        `Translation key "${key}" resolved to an object instead of a string. Available keys:`,
        Object.keys(value)
      );
      return key;
    }
